...
const BookingConfirmation = ({ appointment, onClose, onViewAppointments }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 rounded-2xl p-8 max-w-2xl w-full border border-gray-700 shadow-2xl">
        {/* Success Icon */}
        ...
        {/* Appointment Details */}
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-6 border border-gray-600">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-300 text-sm">{appointment.doctor?.specialization}</p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-green-400 font-semibold text-lg">₹{appointment.consultationFee}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {appointment.reason && (
            <div className="mt-4 pt-4 border-t border-gray-600">
              <p className="text-gray-300 text-sm mb-1">Reason for Visit</p>
          ...
          {appointment.symptoms && appointment.symptoms.length > 0 && (
            <div className="mt-3">
              <p className="text-gray-300 text-sm mb-1">Symptoms</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-200 font-semibold"
          >
            View My Appointments
          </button>
          <button
            onClick={onClose}
            className="flex-1 px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors duration-200 font-semibold"
          >
            Close
          </button>
        </div>
